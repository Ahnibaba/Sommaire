  ...
  return (
    <section className="relative overflow-hidden bg-gray-50">
      ...
      lg:px-0">
        ...
        >
          <div className="relative left-[calc(50%-3rem)] aspect-1155/678
               w-[36.123rem] -translate-x-1/2 bg-linear-to-br
...
function StepItem({ icon, label, description }: Step) {
  return (
    <div className="relative p-6 rounded-2xl bg-white/5
       backdrop-blur-xs border border-white/30 hover:border-rose-500/50
       transition-colors group w-full"
    >
      <div className="flex flex-col gap-4 h-full">
        <div className="flex items-center justify-center h-24 w-24 mx-auto
        rounded-2xl bg-linear-to-br from-rose-500/10
