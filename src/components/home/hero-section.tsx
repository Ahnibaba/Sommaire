    ...
    return (
        <section className="relative mx-auto flex flex-col z-0 items-center justify-center
          py-16 sm:py-20 lg:pb-28 transition-all animate-in lg:px-12 max-w-7xl">
            ...
            <h2 className="text-lg sm:text-xl lg:text-2xl text-center lg:px-0 lg:max-w-4xl text-gray-600">
            ...
            <Button
              ...
              bg-linear-to-r from-slate-900 to-rose-500 hover:to-slate-900 hover:from-rose-500 hover:no-underline
