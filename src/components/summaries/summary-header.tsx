            ...
            <div className="space-y-6">
                <div className="flex flex-wrap items-center gap-4">
                    <Badge
                      ...
                      text-rose-500 rounded-full hover:bg-white/90 transition-all duration-200 shadow-xs hover:shadow-md"
                    >
            ...
            <div className="self-start">
                <Link href={`/dashboard`}>
                    <Button
                        ...
                        hover:shadow-md border border-rose-100/30 bg-rose-100 px-2 sm:px-3"
                    >
                        <ChevronLeft className="h-3 w-3 sm:h-4 sm:w-4 text-rose-500
                          transition-transform group-hover:transate-x-0.5" />
