...
// export interface summariesType {
//   id: number;
//   title: string;
//   summary_text: string;
//   created_at: string;
            ...
            <div className="px-2 py-12 sm:py-24">
                <div className="flex gap-4 mb-8 justify-between">
                    <div className="flex flex-col gap-2">
                        <h1 className="text-4xl font-bold tracking-tight bg-linear-to-r
                ...
                <div className="mb-6">
                  ...
                  <p className="text-sm">
                    ...
                    <Link href="/pricing" className="text-rose-800 underline font-medium underline-offset-4 inline-flex items-center">
                      Click here to upgrade to Pro{" "} <ArrowRight className="size-4 inline-block" /> 
                    </Link>
